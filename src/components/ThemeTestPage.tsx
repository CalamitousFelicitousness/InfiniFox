  ...
  return (
    <div className="theme-test-page">
      <header className="test-header">
        ...
        <p>
          Current Theme: <strong>{currentThemeName}</strong> ({theme.mode} mode)
        </p>
      </header>
            ...
            <div className="tab-panel active">
              ...
              <div className="typography-samples">
                ...
                <p className="body-text">
                  This is body text with normal weight. It should be easily readable with good
                  contrast against the background. The line height and letter spacing are optimized
                  for readability.
                </p>

                <p className="body-text-small">Small body text for less prominent information.</p>
          ...
          {activeTab === 'components' && (
            <div className="tab-panel active">
              ...
              <div className="tooltip-samples">
                ...
                >
                  Hover for tooltip
                  {showTooltip && <div className="tooltip tooltip-top">This is a tooltip!</div>}
                </div>
              </div>
            </div>
          )}
                ...
                <div className="toolbar-demo">
                  ...
                  <div className="toolbar">
                    <button className="toolbar-btn">
                      <Icon icon={Brush} size="base" />
                    </button>
                    <button className="toolbar-btn">
                      <Icon icon={Pencil} size="base" />
                    </button>
                    <button className="toolbar-btn">
                      <Icon icon={Search} size="base" />
                    </button>
                    <button className="toolbar-btn">
                      <Icon icon={Undo2} size="base" />
                    </button>
                  </div>
                </div>
