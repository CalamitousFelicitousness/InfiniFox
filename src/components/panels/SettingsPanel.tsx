          ...
          <div class="form-help">
            ...
            {apiType && (
              <div class="mt-1 text-xs">
                Supports: {getApiFeatures(apiType).websocket ? <CheckCircle class="icon-xs inline-icon success" /> : <XCircle class="icon-xs inline-icon error" />} WebSocket,
                {' '}{getApiFeatures(apiType).rest ? <CheckCircle class="icon-xs inline-icon success" /> : <XCircle class="icon-xs inline-icon error" />} REST Polling
              </div>
            )}
          </div>
        </div>
