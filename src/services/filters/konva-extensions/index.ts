...
export const FilterPerformance = {
   ...
   */
  estimateProcessingTime: (filterName: string, imageWidth: number, imageHeight: number): number => {
   ...
   */
  needsProgressiveRendering: (imageWidth: number, imageHeight: number): boolean => {
    const pixelCount = imageWidth * imageHeight
