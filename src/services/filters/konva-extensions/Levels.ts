 ...
 */
export function calculateHistogram(data: Uint8ClampedArray, channel: 'rgb' | 'red' | 'green' | 'blue' = 'rgb'): Uint32Array {
  const histogram = new Uint32Array(256);
  
  let channelOffset = 0;
  switch (channel) {
    case 'red': channelOffset = 0; break;
    case 'green': channelOffset = 1; break;
    case 'blue': channelOffset = 2; break;
  }
...
export const LevelsHelpers = {
   ...
   */
  autoLevels(histogram: Uint32Array, clipPercent: number = 0.1): { inputBlack: number; inputWhite: number } {
